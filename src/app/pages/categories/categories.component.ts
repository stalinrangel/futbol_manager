...
export class CategoriesComponent implements OnInit {
  ...
  create(){
    ...
    let self=this;
    this.formData.append("name", this.jugador.name);
    this.formData.append("category", this.jugador.category);
    this.p.create_section(this.formData).subscribe({
      next(data){
        console.log(data);
      },error(err){
        console.log(err);
